...
namespace Wrench.Data.Migrations
{
    ...
    [Migration("20210907231021_valor_cobrado")]
    partial class valor_cobrado
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemandaTag", b =>
                {
                    b.Property<int>("DemandasIdDemanda")
                        .HasColumnType("int");

                    b.Property<int>("TagsIdTag")
                        .HasColumnType("int");

                    b.HasKey("DemandasIdDemanda", "TagsIdTag");

                    b.HasIndex("TagsIdTag");

                    b.ToTable("TagDemandas");
                });
            ...
            modelBuilder.Entity("Wrench.Domain.Entities.RegistroServico", b =>
                {
                    ...
                    b.Property<bool>("CheckDemandante")
                        .HasColumnType("bit");

                    b.Property<bool>("CheckPrestador")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("ValorCobradoDemandante")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ValorCobradoPrestador")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DemandaTag", b =>
                {
                    b.HasOne("Wrench.Domain.Entities.Demanda", null)
                        .WithMany()
                        .HasForeignKey("DemandasIdDemanda")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Wrench.Domain.Entities.Demanda", b =>
                {
                    b.HasOne("Wrench.Domain.Entities.Identity.AppUser", "Elaborador")
                        .WithMany()
                        .HasForeignKey("IdElaborador")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
